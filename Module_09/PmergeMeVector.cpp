...
/*   Updated: 2024/05/18 18:49:19 by lyandriy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_pos(std::vector<size_t> &myvector)
{
	std::cout << "myvector:";
...
void	bynary_search(std::pair<int, int> small, std::vector<std::pair<int, int> > &big, size_t begin, size_t end, std::vector<size_t> &pos)
{
	std::vector<std::pair<int, int> >::iterator it = big.begin();
...
std::vector<std::pair<int, int> >	insert(std::vector<std::pair<int, int> > &big, std::vector<std::pair<int, int> > &small)
{
	...
	for (size_t i = 1; i < (small.size()); i++)
	{
		...
		//std::cout << "j " << j << " pos " << pos[r - 1] << " r " << r << " a " << a << std::endl;
		bynary_search(small[a - 1], big, 0, pos[r - 1], pos);
		/*print_cont(big_d);
		print_cont(small);
		print_cont(big);
		print_pos(pos);*/
